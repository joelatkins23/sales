...
return [
	...
	"Sale Invoice Initial Number" => "Sale Invoice Initial Number",
	"POS Invoice Initial Number" => "POS Invoice Initial Number",
	...
	"Zone" => "Zone",
	"Trucks" => "Trucks",
	"Truck List" => "Listado camiones",
	"Add Truck" => "Agrear camion",
	"Model" => "Modelo",
	"Identification" => "Placa",
	"Maximum Capacity" => "Capacidad Maxima",
	"Driver's Name" => "Conductor",
	"Transaction Details" => "Carga de pedidos",
