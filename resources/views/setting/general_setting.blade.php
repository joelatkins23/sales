                    ...
                    <div class="card-body">
                        ...
                        {!! Form::open(['route' => 'setting.generalStore', 'files' => true, 'method' => 'post']) !!}
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>{{trans('file.Sale Invoice Initial Number')}} *</strong></label>
                                        <input type="number" name="sale_invoice_initial_number" class="form-control" value="@if($lims_general_setting_data){{$lims_general_setting_data->sale_invoice_initial_number}}@endif" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label><strong>{{trans('file.POS Invoice Initial Number')}} *</strong></label>
                                        <input type="number" name="pos_invoice_initial_number" class="form-control" value="@if($lims_general_setting_data){{$lims_general_setting_data->pos_invoice_initial_number}}@endif" required />
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
