    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center">{{trans('file.Purchases Report')}}</h3>
            </div>
                ...
                <div class="col-md-4 mt-4">
                    <div class="form-group row">
                        ...
                        <div class="d-tc">
                            ...
                            <select id="supplier_id" name="supplier_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" style="width:200px" >
            ...
            <div class="table-responsive">
                <table id="report-table" class="table table-hover">
                    ...
                    <tbody>
                       @foreach($purchases_list as $key=>$item)
                        <tr>
                            <td>{{$key}}</td>
...
<script type="text/javascript">
    ...
    $("ul#report #purchases-report-menu").addClass("active");
