        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              ?>
              @if($index_permission_active)
              <li><a href="#event" aria-expanded="false" data-toggle="collapse"> <i class="ion-clock"></i><span>{{trans('file.Event')}}</span></a>
                <ul id="event" class="collapse list-unstyled ">
                  <li id="event-list-menu"><a href="{{route('event.index')}}">{{trans('file.Event list')}}</a></li>
                  <?php 
                  ...
                  ?>
                  @if($add_permission_active)
                  <li id="event-create-menu"><a href="{{route('event.create')}}">{{trans('file.Add Event')}}</a></li>
                  @endif
                </ul>
              </li>
              @endif
              ...
              ?>
              @if($index_permission_active)
              <li><a href="{{route('calendar.index')}}" > <i class="ion-calendar"></i><span>{{trans('file.Calendar')}}</span></a>
