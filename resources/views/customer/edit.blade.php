                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong>{{trans('file.Credit Limit')}}</strong></label>
                                    <input type="number" name="credit_limit" class="form-control" value="{{$lims_customer_data->credit_limit}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong>{{trans('file.Zone')}}</strong></label>
                                    <input type="text" name="zone" class="form-control" value="{{$lims_customer_data->zone}}">
                                </div>
                            </div>
                            <div class="col-md-12">
