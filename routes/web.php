...
Route::group(['middleware' => ['auth', 'active']], function() {
	...
	Route::post('trucks/change_status', 'TruckController@change_status')->name('trucks.change_status');	
	...
	Route::post('accounts/transfer-money', 'AccountsController@transferMoney')->name('accounts.transferMoney');
