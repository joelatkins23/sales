    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header mt-2">
                <h3 class="text-center"><?php echo e(trans('file.Purchases Report')); ?></h3>
            </div>
            <?php echo Form::open(['route' => 'report.purchases', 'method' => 'post']); ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="d-tc">
                            ...
                            <select id="supplier_id" name="supplier_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" style="width:200px" >
                                <option value="0"><?php echo e(trans('file.All Supplier')); ?></option>
            ...
            <div class="table-responsive">
                <table id="report-table" class="table table-hover">
                    ...
                    <tbody>
                       <?php $__currentLoopData = $purchases_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
