                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="reference_no" class="form-control" value="<?php echo e($lims_purchase_data->reference_no); ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">                                 
                                        <div class="form-group">
                                            <label><strong><?php echo e(trans('file.Biller')); ?> *</strong></label>
                                            <input type="hidden" name="biller_id_hidden" value="<?php echo e($lims_purchase_data->biller_id); ?>" />
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="note" value="<?php echo e($lims_purchase_data->note); ?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
