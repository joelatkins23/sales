    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
                <?php echo Form::open(['route' => 'trucks.addqty', 'method' => 'post', 'files' => true]); ?>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        ...
                        <input type="hidden" name="track_id" value="<?php echo e($truck_id); ?>">
                        <input type="hidden" name="start-date" value="<?php echo e($start_date); ?>">
                        <input type="hidden" name="end-date" value="<?php echo e($end_date); ?>">
                    </div>
                    <div class="col-md-6 form-group">
