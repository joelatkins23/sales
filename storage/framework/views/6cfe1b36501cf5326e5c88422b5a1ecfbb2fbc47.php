            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <?php echo Form::open(['route' => 'sales.store', 'method' => 'post', 'files' => true, 'class' => 'sale-form']); ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_id" id="customer_id" class="selectpicker js-example-placeholder-single js-states form-control" data-live-search="true" title="Select customer...">
                                                ...
                                                <?php
                                                    ...
                                                    $credit_limit[$customer->id] = $customer->credit_limit;
                                                ?>
                                ...
                                <div class="row mt-2">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select required name="account_id" id="account_id" class="selectpicker form-control" data-live-search="true" data-live-search-style="begins" title="Select account...">
...
var credit_limit = <?php echo json_encode($credit_limit) ?>;
var rowindex;
...
function checkQuantity(sale_qty, flag) {
    ...
    if(product_type[pos] == 'standard'){
        ...
        if (total_qty > parseFloat(product_qty[pos])) {
            alert('Cantidad excede la cantidad en stock!');
            if (flag) {
...
$('input[name="paid_amount"]').on("input", function() {
    if( $(this).val() > parseFloat($('input[name="paying_amount"]').val()) ) {
        alert('Cantidad de Pago no puede ser mayor a la cantidad recivida');
        $(this).val('');
    }
