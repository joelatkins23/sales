        ...
        <div class="side-navbar-wrapper">
          ...
          <div class="main-menu">
            <ul id="side-main-menu" class="side-menu list-unstyled">                  
              ...
              <?php endif; ?>
              <li><a href="#truck" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-truck"></i><span><?php echo e(trans('file.Trucks')); ?></span></a>
                <ul id="truck" class="collapse list-unstyled ">
                  <li id="truck-list-menu"><a href="<?php echo e(route('trucks.index')); ?>"><?php echo e(trans('file.Truck List')); ?></a></li>
                  <li><a id="add-truck" href=""> <?php echo e(trans('file.Add Truck')); ?></a></li>
                </ul>
              </li>
              <?php 
              ...
              <li><a href="#sale" aria-expanded="false" data-toggle="collapse"> <i class="icon ion-ios-cart-outline"></i><span><?php echo e(trans('file.Sale')); ?></span></a>
                <ul id="sale" class="collapse list-unstyled ">
                  ...
                  ?>
                  <?php if($add_permission_active): ?>
                  <li><a href="<?php echo e(route('sale.pos')); ?>">Factura</a></li>
              ...
              <li class=""><a href="#account" aria-expanded="false" data-toggle="collapse"> <i class="fa fa-university"></i><span><?php echo e(trans('file.Accounting')); ?></span></a>
                <ul id="account" class="collapse list-unstyled ">
                  ...
                  <?php endif; ?>
                  <li id="transfer-money-menu"><a id="transfer-money" href=""><?php echo e(trans('file.Transfer Money')); ?></a></li>
                </ul>
              </li>
              <?php endif; ?>
              <?php 
          ...
          <div class="container-fluid">
            <div class="navbar-holder d-flex align-items-center justify-content-between">
              ...
              <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                ...
                ?>
                <?php if($add_permission_active): ?>
                <li class="nav-item"><a class="dropdown-item" href="<?php echo e(route('sale.pos')); ?>"><i class="fa fa-th-large"></i><span> Factura</span></a></li>
                <?php endif; ?>            
    ...
    <div class="page">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    <?php echo Form::open(['route' => 'trucks.store', 'method' => 'post']); ?>
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label><strong><?php echo e(trans('file.Maximum Capacity')); ?> *</strong></label>
                            <input type="number" name="capacity" step="any" required class="form-control">
                        </div>
                        <div class="col-md-6 form-group">
                            <label><strong><?php echo e(trans('file.Unit')); ?> *</strong></label>
      ...
      <div id="transfer-money-modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
        <div role="document" class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 id="exampleModalLabel" class="modal-title"><?php echo e(trans('file.Transfer Money')); ?></h5>
                    <button type="button" data-dismiss="modal" aria-label="Close" class="close"><span aria-hidden="true">×</span></button>
                </div>
                <div class="modal-body">
                  <p class="italic"><small><?php echo e(trans('file.The field labels marked with * are required input fields')); ?>.</small></p>
                    <?php echo Form::open(['route' => 'accounts.transferMoney', 'method' => 'post']); ?>

                      <div class="row">
                          <div class="col-md-6 form-group">
                              <label><strong> <?php echo e(trans('file.From Account')); ?> *</strong></label>
                          ...
                          <div class="col-md-6 form-group">
                              <label><strong> <?php echo e(trans('file.To Account')); ?> *</strong></label>
