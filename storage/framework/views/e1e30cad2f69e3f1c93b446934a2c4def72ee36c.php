                                ...
                                <div class="table-responsive">
                                    <table id="myTable" class="table table-hover order-list table-fixed">
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                <td class="col-sm-4 product-title"><strong><?php echo e($product_data->name); ?></strong> [<?php echo e($product_data->code); ?>] <button type="button" class="edit-product btn btn-link" data-toggle="modal" data-target="#editModal"> <i class="fa fa-edit"></i></button> </td>
