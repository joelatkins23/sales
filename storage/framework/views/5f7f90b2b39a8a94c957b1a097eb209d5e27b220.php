                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            ...
                            <div class="row">
                                ...
                                <div id="alert-qty" class="col-md-4">
                                    <div class="form-group">
                                        <label><strong><?php echo e(trans('file.weight')); ?></strong> </label>
                                        <input type="text" name="weight" value="<?php echo e($lims_product_data->weight); ?>" class="form-control" step="any">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4" id="promotion_price">   <label><strong><?php echo e(trans('file.Promotional Price')); ?></strong></label>
