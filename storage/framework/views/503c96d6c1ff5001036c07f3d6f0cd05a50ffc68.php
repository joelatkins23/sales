                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong><?php echo e(trans('file.Credit Limit')); ?></strong></label>
                                    <input type="number" name="credit_limit" class="form-control" value="<?php echo e($lims_customer_data->credit_limit); ?>">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label><strong><?php echo e(trans('file.Zone')); ?></strong></label>
                                    <input type="text" name="zone" class="form-control" value="<?php echo e($lims_customer_data->zone); ?>">
                                </div>
                            </div>
                            <div class="col-md-12">
