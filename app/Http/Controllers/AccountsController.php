...
class AccountsController extends Controller
{
    ...
    public function balanceSheet()
    {
        ...
        if($role->hasPermissionTo('balance-sheet')){
            ...
            foreach ($lims_account_list as $account) {
                ...
                $sent_money_via_transfer = TransferMoney::where('from_account_id', $account->id)->sum('amount');
                $recieved_money_via_transfer = TransferMoney::where('to_account_id', $account->id)->sum('amount');
    ...
    public function accountStatement(Request $request)
    {
        ...
        if($data['type'] == '0' || $data['type'] == '2'){
            ...
            $recieved_money_transfer_list = TransferMoney::where('to_account_id', $data['account_id'])->get();
        }
        if($data['type'] == '0' || $data['type'] == '1'){
            ...
            $sent_money_transfer_list = TransferMoney::where('from_account_id', $data['account_id'])->get();
        }
        $balance = 0;
