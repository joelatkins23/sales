...
class SettingController extends Controller
{
    ...
    public function generalSettingStore(Request $request)
    {
        ...
        $general_setting->sale_invoice_initial_number = $data['sale_invoice_initial_number'];
        $general_setting->pos_invoice_initial_number = $data['pos_invoice_initial_number'];
