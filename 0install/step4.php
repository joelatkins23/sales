...
$url = 'salepropos.com/saleproposverify/';
...
<html lang="en">
<head>
    <title>SaleProPOS Installer</title>
    ...
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            <header>
                ...
                <h1 class="text-center">SaleProPOS Auto Installer</h1>
            </header>
            <hr>
            <div class="content pad-top-bot-50">
                <p>
                    <h5><strong class="theme-color">Congratulations!</strong>
                    You have successfully installed SaleProPOS!</h5><br>
